...
import 'package:developer_romantan/Views/soonDialog.dart';
...
class _OptionScreenState extends State<OptionScreen> {
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                            flex: 1,
                            child: _getFormatedTextField(
                                heightController, savedHeight),
                          ),
                          Expanded(
                            flex: 4,
                            child: SizedBox(),
                ...
                Row(
                  ...
                  children: <Widget>[
                    RaisedButton(
                      ...
                      onPressed: () async {
                        var prefs = await SharedPreferences.getInstance();
                        await prefs.setInt("maze_width",
                            toInt(widthController.text, defaultValue: 8));
                        await prefs.setInt("maze_height",
                            toInt(heightController.text, defaultValue: 8));
  ...
  TextField _getFormatedTextField(
      TextEditingController controller, int savedValue) {
    return TextField(
      autofocus: false,
      autocorrect: false,
